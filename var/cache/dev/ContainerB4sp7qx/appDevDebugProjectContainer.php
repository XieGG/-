...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'security.authentication.listener.anonymous.admin_firewalls' => 'getSecurity_Authentication_Listener_Anonymous_AdminFirewallsService.php',
            'security.authentication.listener.form.admin_firewalls' => 'getSecurity_Authentication_Listener_Form_AdminFirewallsService.php',
            'security.authentication.provider.anonymous.admin_firewalls' => 'getSecurity_Authentication_Provider_Anonymous_AdminFirewallsService.php',
            'security.authentication.provider.dao.admin_firewalls' => 'getSecurity_Authentication_Provider_Dao_AdminFirewallsService.php',
            'security.authentication.session_strategy.admin_firewalls' => 'getSecurity_Authentication_SessionStrategy_AdminFirewallsService.php',
            ...
            'security.firewall.map.context.admin_firewalls' => 'getSecurity_Firewall_Map_Context_AdminFirewallsService.php',
            ...
            'security.user.provider.concrete.database_admin_users' => 'getSecurity_User_Provider_Concrete_DatabaseAdminUsersService.php',
        ...
        $this->privates = array(
            ...
            'security.authentication.listener.anonymous.admin_firewalls' => true,
            'security.authentication.listener.form.admin_firewalls' => true,
            'security.authentication.manager' => true,
            'security.authentication.provider.anonymous.admin_firewalls' => true,
            'security.authentication.provider.dao.admin_firewalls' => true,
            'security.authentication.session_strategy.admin_firewalls' => true,
            ...
            'security.firewall.map.context.admin_firewalls' => true,
            ...
            'security.user.provider.concrete.database_admin_users' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MKscIykrlb', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4znWqCeGrT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qiQGwVpzeP', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1sGDt4Yj0t', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hJ+IL1qoXx', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['security.authentication.provider.dao.admin_firewalls']) ? $this->services['security.authentication.provider.dao.admin_firewalls'] : $this->load('getSecurity_Authentication_Provider_Dao_AdminFirewallsService.php')) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['security.authentication.provider.anonymous.admin_firewalls']) ? $this->services['security.authentication.provider.anonymous.admin_firewalls'] : ($this->services['security.authentication.provider.anonymous.admin_firewalls'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash')))) && false ?: '_'};
        }, 2), true);
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.admin_firewalls' => function () {
            return ${($_ = isset($this->services['security.firewall.map.context.admin_firewalls']) ? $this->services['security.firewall.map.context.admin_firewalls'] : $this->load('getSecurity_Firewall_Map_Context_AdminFirewallsService.php')) && false ?: '_'};
            ...
            yield 'security.firewall.map.context.admin_firewalls' => ${($_ = isset($this->services['security.request_matcher.z8xqmvs']) ? $this->services['security.request_matcher.z8xqmvs'] : ($this->services['security.request_matcher.z8xqmvs'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'))) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/AuthBundle/Resources/views'), 'Auth');
        $instance->addPath(($this->targetDirs[3].'/src/AuthBundle/Resources/views'), '!Auth');
