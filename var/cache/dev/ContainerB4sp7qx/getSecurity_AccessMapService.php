...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/auth/login'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/auth/logout'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/auth/check'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
