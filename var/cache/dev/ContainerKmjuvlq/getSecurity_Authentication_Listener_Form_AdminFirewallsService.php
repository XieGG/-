...
// Returns the private 'security.authentication.listener.form.admin_firewalls' shared service.
...
$b->setOptions(array('login_path' => 'auth_login_index', 'default_target_path' => '/admin', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
$b->setProviderKey('admin_firewalls');
...
$d->setOptions(array('login_path' => 'auth_login_index', 'failure_path' => 'auth_login_index', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

return $this->services['security.authentication.listener.form.admin_firewalls'] = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : ($this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())) && false ?: '_'}, ${($_ = isset($this->services['security.authentication.manager']) ? $this->services['security.authentication.manager'] : $this->getSecurity_Authentication_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['security.authentication.session_strategy.admin_firewalls']) ? $this->services['security.authentication.session_strategy.admin_firewalls'] : ($this->services['security.authentication.session_strategy.admin_firewalls'] = new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'))) && false ?: '_'}, $a, 'admin_firewalls', $b, $d, array('check_path' => 'auth_login_check', 'username_parameter' => '_username', 'password_parameter' => '_password', 'use_forward' => false, 'require_previous_session' => false, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, ${($_ = isset($this->services['debug.event_dispatcher']) ? $this->services['debug.event_dispatcher'] : $this->getDebug_EventDispatcherService()) && false ?: '_'}, NULL);
