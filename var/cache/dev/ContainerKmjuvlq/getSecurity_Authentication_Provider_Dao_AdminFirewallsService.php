...
// Returns the private 'security.authentication.provider.dao.admin_firewalls' shared service.
...
return $this->services['security.authentication.provider.dao.admin_firewalls'] = new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.database_admin_users']) ? $this->services['security.user.provider.concrete.database_admin_users'] : $this->load('getSecurity_User_Provider_Concrete_DatabaseAdminUsersService.php')) && false ?: '_'}, new \Symfony\Component\Security\Core\User\UserChecker(), 'admin_firewalls', ${($_ = isset($this->services['security.encoder_factory']) ? $this->services['security.encoder_factory'] : $this->load('getSecurity_EncoderFactoryService.php')) && false ?: '_'}, true);
