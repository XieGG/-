...
// Returns the private 'security.firewall.map.context.admin_firewalls' shared service.
...
return $this->services['security.firewall.map.context.admin_firewalls'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ${($_ = isset($this->services['security.authentication.listener.form.admin_firewalls']) ? $this->services['security.authentication.listener.form.admin_firewalls'] : $this->load('getSecurity_Authentication_Listener_Form_AdminFirewallsService.php')) && false ?: '_'};
    yield 3 => ${($_ = isset($this->services['security.authentication.listener.anonymous.admin_firewalls']) ? $this->services['security.authentication.listener.anonymous.admin_firewalls'] : $this->load('getSecurity_Authentication_Listener_Anonymous_AdminFirewallsService.php')) && false ?: '_'};
...
}, 5), new \Symfony\Component\Security\Http\Firewall\ExceptionListener(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : ($this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())) && false ?: '_'}, ${($_ = isset($this->services['security.authentication.trust_resolver']) ? $this->services['security.authentication.trust_resolver'] : ($this->services['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver('Symfony\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken', 'Symfony\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken'))) && false ?: '_'}, $a, 'admin_firewalls', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint(${($_ = isset($this->services['http_kernel']) ? $this->services['http_kernel'] : $this->getHttpKernelService()) && false ?: '_'}, $a, 'auth_login_index', false), NULL, NULL, ${($_ = isset($this->services['monolog.logger.security']) ? $this->services['monolog.logger.security'] : $this->load('getMonolog_Logger_SecurityService.php')) && false ?: '_'}, false), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('admin_firewalls', 'security.user_checker', 'security.request_matcher.z8xqmvs', true, false, 'security.user.provider.concrete.database_admin_users', 'admin_firewalls', 'security.authentication.form_entry_point.admin_firewalls', NULL, NULL, array(0 => 'form_login', 1 => 'anonymous'), NULL));
